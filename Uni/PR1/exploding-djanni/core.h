...
#define AI_WORRIED_BUT_DRAW_ANYWAY_PCT 20 // pct of drawing a card in that specific turn when worried
#define AI_MORE_WORRIED_PCT 80 // pct of using a safelife card in that specific turn when worried
#define PCT_MIN 0
#define PCT_MAX 100
